...
Driftgate adapter id: `claude-code` · Verified against 2.x on 2026-09-01 · [Homepage](https://docs.claude.com/en/docs/claude-code)
...
- **info** — Driftgate writes CLAUDE.md only. `.claude/settings.json` carries permissions and hooks — a materially different trust surface from instructions — and generating it is deliberately out of scope for v0.
