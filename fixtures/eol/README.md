...
checkout. If Rulegate were sensitive to that, every generated file would report as
hand-edited on every Windows checkout, and `rulegate check` would fail CI for every
