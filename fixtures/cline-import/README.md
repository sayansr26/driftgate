...
- `generated.md` carries the generated-file marker, so Driftgate wrote it and it is split
...
- `style.md` has no marker, so it is somebody's hand-written file and is imported
  **whole**: `## Style` stays in the body. In a file Driftgate did not write, a heading is
